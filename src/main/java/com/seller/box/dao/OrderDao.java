...
public interface OrderDao {
	List<EdiPicklist> findReadyToPick(@Param("etailorId") Integer etailorId, @Param("warehouseCode") String warehouseCode, @Param("picklistFor") String picklistFor, @Param("picklistStatus") String picklistStatus);

	List<ReadyToShip> findReadyToShip(int etailorId, String warehouseCode, String pickupDate, String pickupOtherDate, String carrierName);
	...
	Map<String, Object> findPicklistStatus(int etailorId, String warehouseCode, String scanedValue);
