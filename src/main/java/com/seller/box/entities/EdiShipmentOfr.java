...
@Entity
@Table(name = "EDI_SHIPMENT_OFR", catalog = "SELLER")
public class EdiShipmentOfr implements Serializable{
	...
	@Column(name = "ORDER_ACCEPTED_DATE")
	...
	@Column(name = "OFR_FILE_PATH")
	private String	ofrFilePath;
	...
	public void setOfrId(Long ofrId) {
		this.ofrId = ofrId;
	}
...
public String getMessageStructureVersion() {
	...
	public String getOfrFilePath() {
		return ofrFilePath;
	}
	public void setOfrFilePath(String ofrFilePath) {
		this.ofrFilePath = ofrFilePath;
	}
	...
	public String toString() {
		return "EdiShipmentOfr [ofrId=" + ofrId + ", ediOrderId=" + ediOrderId + ", eretailorId=" + eretailorId
				...
				+ customerOrderNumber + ", orderAcceptedDate=" + orderAcceptedDate + ", orderStatus=" + orderStatus
				+ ", responseCondition=" + responseCondition + ", resultCode=" + resultCode + ", resultDescription="
				+ resultDescription + ", inventoryEffectiveDate=" + inventoryEffectiveDate + ", numberOfItems="
				+ numberOfItems + ", runStatus=" + runStatus + ", txnStatus=" + txnStatus + ", processInstanceId="
				+ processInstanceId + ", ofrFilePath=" + ofrFilePath + ", txnErrorMsg=" + txnErrorMsg + ", createdDate="
				+ createdDate + ", createdBy=" + createdBy + ", outboundDate=" + outboundDate + "]";
	}
}
